...
- **🚀 Live Demo**: [atmosphere-verb-bat.vercel.app](https://atmosphere-verb-bat.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/atmosphere-verb-bat)
...
1. `git clone https://github.com/blefnk/atmosphere-verb-bat.git`
2. `cd atmosphere-verb-bat`
3. `bun i`
